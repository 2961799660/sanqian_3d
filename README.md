...
[![Speed](https://img.shields.io/badge/速度-8--12s%20Turbo%20%7C%2030s%20P1-success)]()
[![Engines](https://img.shields.io/badge/引擎-P1%20%7C%20v3.1%20%7C%20Turbo%20%7C%20v1.4-orange)]()
[![Export](https://img.shields.io/badge/导出-GLB%20%7C%20FBX%20%7C%20USDZ%20%7C%20OBJ-purple)]()
...
![工坊 · 文本生 3D](./screenshots/3d-workshop-text.png)
...
![工坊 · 多视图](./screenshots/3d-workshop-multiview.png)
...
![14 项能力计费](./screenshots/3d-pricing.png)
...
![范例模型墙](./screenshots/3d-showcase.png)
...
![后台统计](./screenshots/3d-admin-stats.png)

### 用户管理

按手机号搜索 + 创建用户,余额 / 注册时间一表查询,支持 +/- 调积分、改密、封禁。

![用户管理](./screenshots/3d-admin-users.png)
...
![功能定价](./screenshots/3d-admin-pricing.jpg)
...
![配置](./screenshots/3d-admin-config.png)

---

## 💼 授权方案

![三档授权](./screenshots/3d-licensing.jpg)
...
> 💬 具体方案按需求细聊,加商务微信 **q2026560558** 沟通(备注"三千AI · 3D")
...
|---|---|---|
| ![](./screenshots/3d-workshop-text.png) | ![](./screenshots/3d-workshop-image.png) | ![](./screenshots/3d-workshop-multiview.png) |

| 导入已有 3D 文件(免费) | 范例模型墙 | 计费明细 |
|---|---|---|
| ![](./screenshots/3d-workshop-import.png) | ![](./screenshots/3d-showcase.png) | ![](./screenshots/3d-pricing.png) |
